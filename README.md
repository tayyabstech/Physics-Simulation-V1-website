...
## Preview locally
Open `index.html` in a browser, or run any static server in this folder, e.g.:
...
2. Drag and drop this `website` folder onto the page (or import it via Git).
3. Framework preset: **Other**. No build command, no output directory — it's already static.
